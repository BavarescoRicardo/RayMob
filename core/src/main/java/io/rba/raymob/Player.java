...
public class Player {
    ...
    private final double moveSpeed = 1.0; // Velocidade de movimento (pixels por ciclo)
    private final double turnSpeed = Math.PI / 200; // Velocidade de rotação (radianos por ciclo)
